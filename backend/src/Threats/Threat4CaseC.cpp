...
const std::unordered_map<ThreatFinder::ThreatAnatnomy, int> Threat4CaseC::k_ATOM_NUMBER_4C= {
...
void Threat4CaseC::getThreatUpDetails(const IBoard::PositionXY initialPosition, const Trend trend,
