...
void Threat3CaseC::getThreatUpDetails(const IBoard::PositionXY initialPosition, const Trend trend,
                                      ThreatUpDetails & rThreatUpDetails) const
{
    ...
    IBoard::PositionXY pretendExtGap1 = rThreatUpDetails.m_myPawns[2];
