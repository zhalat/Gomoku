...
const uint32_t Threat4CaseAA::m_pov[] = {1, 2, 3, 4, 5 };

Threat4CaseAA::Threat4CaseAA() : ThreatFinder(PATTERN_LENGHT, m_pov, NUMELEM(m_pov), k_ATOM_NUMBER_4AA)
{
    // nothing to do.
}

///	Check pretendThreat if meets all requirement to real threat.
bool Threat4CaseAA::checkThreat(const uint32_t pretendThreat, const uint32_t pointOfView,
...
void Threat4CaseAA::getThreatUpDetails(const IBoard::PositionXY initialPosition, const Trend trend,
