...
public:
    ...
    struct PositionXY
    {
        ...
        PositionXY( uint32_t x = 0, uint32_t y = 0 )
        : m_x( x )
        , m_y( y )
        {}
    ...
    struct PositionField
    {
        ...
        PositionField( uint32_t field = 0 )
        : m_field( field )
        {}

        // Converter: PositionXY2PositionField.
        PositionField( const uint32_t boardSize, const PositionXY& xy )
        {
            this->m_field = boardSize * xy.m_x + xy.m_y;
        }

        // Converter: PositionField2Node. Usefull in unit tests.
        operator graph::Node() const
        {
            return m_field;
        }
    ...
    ///////////////////////////////////////////////////////////////////////
    virtual IteratorIf<graph::Node>* GetIterator() const
    {
        return  m_pIterator;
    }
