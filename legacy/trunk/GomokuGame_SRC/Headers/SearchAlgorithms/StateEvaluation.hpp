...
///////////////////////////////////////////////////////////////////////////////////////////
class StateEvaluation: public StateEvaluationIf,
...
public:
	...
	typedef bool( StateEvaluation::*FuncPtr )( const bool, Board::PositionXY&, bool, const BoardScore*, const BoardScore*  ) const;
	//using FuncPtr = bool( StateEvaluation::* )( const bool, Board::PositionXY&, bool, const BoardScore*, const BoardScore* ) const;
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    virtual bool ExtendWinnerThreatMove( const bool isMaxPlayer, Board::PositionXY& rBuildUpMove, int& rStateScore ) const;
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    virtual bool ExtendWinnerActionMove( const bool isMaxPlayer, Board::PositionXY& rBuildUpMove, int& rStateScore ) const;
...
private:
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    bool HeadShotRun( const HeadShotAction headShotAction,
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    bool IsHeadShot4BCPossible( const bool isMaxPlayer, Board::PositionXY& rBuildUpMove, const bool checkWinnerMoveCondition = true,
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    bool IsHeadShot3APossible( const bool isMaxPlayer, Board::PositionXY& rBuildUpMove, const bool checkWinnerMoveCondition = true,
																						const BoardScore* pCpuBoardScore = NULL,
																						const BoardScore* pHumanBoardScore = NULL ) const;
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    bool IsHeadShot3AAPossible( const bool isMaxPlayer, Board::PositionXY& rBuildUpMove, const bool checkWinnerMoveCondition = true,
																						 const BoardScore* pCpuBoardScore = NULL,
																						 const BoardScore* pHumanBoardScore = NULL ) const;
    ...
    ///         false otherwise.
    /////////////////////////////////////////////////////////////////////////////////////
    bool IsHeadShotDragonPossible( const bool isMaxPlayer, Board::PositionXY& rBuildUpMove, const bool checkWinnerMoveCondition = true,
																							const BoardScore* pCpuBoardScore = NULL,
																							const BoardScore* pHumanBoardScore = NULL ) const;
    ...
    ///         false otherwise.
    /////////////////////////////////////////////////////////////////////////////////////
    bool IsHeadShotLizardPossible( const bool isMaxPlayer, Board::PositionXY& rBuildUpMove, const bool checkWinnerMoveCondition = true,
																							const BoardScore* pCpuBoardScore = NULL,
																							const BoardScore* pHumanBoardScore = NULL ) const;
    ...
    /////////////////////////////////////////////////////////////////////////////////////
    bool IsDouble3AOneStrokePossible( const bool isMaxPlayer, Board::PositionXY& rBuildUpMove, const bool checkWinnerMoveCondition = true,
																							   const BoardScore* pCpuBoardScore = NULL,
																							   const BoardScore* pHumanBoardScore = NULL ) const;
    ...
    ///         false otherwise.
    /////////////////////////////////////////////////////////////////////////////////////
    bool IsDouble3AMitigationPossible( const bool isMaxPlayer, Board::PositionXY& rBuildDownMove, const bool checkWinnerMoveCondition = true,
																								  const BoardScore* pCpuBoardScore = NULL,
																								  const BoardScore* pHumanBoardScore = NULL ) const;
    ...
    ///         false otherwise.
    /////////////////////////////////////////////////////////////////////////////////////
    bool IsBlockAndAttack3APossible( const bool isMaxPlayer, Board::PositionXY& rBuildDownMove, const bool checkWinnerMoveCondition = true,
																								const BoardScore* pCpuBoardScore = NULL,
																								const BoardScore* pHumanBoardScore = NULL ) const;
