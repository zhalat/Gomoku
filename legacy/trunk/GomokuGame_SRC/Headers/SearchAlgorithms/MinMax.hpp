...
private:
    ...
    ///////////////////////////////////////////////////////////////////////
    ScoreForMove GameTreeBrowsing( VectorUniqueType& rCandidates, PriorityQueueScore& bestMoves, vector< Board::PositionXY >& treeTracker, const uint32_t deep = 0 );
