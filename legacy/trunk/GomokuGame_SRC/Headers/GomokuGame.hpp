...
public:
    ...
    ///////////////////////////////////////////////////////////////////////
    virtual void Init( const uint32_t size,
...
private:
    ...
    ///////////////////////////////////////////////////////////////////////
    Board::PositionXY RandomizeBestMove( const SearchTreeAlgorithmIf::PriorityQueueScore& nBestMoves, const uint32_t diversityPercent ) const;
