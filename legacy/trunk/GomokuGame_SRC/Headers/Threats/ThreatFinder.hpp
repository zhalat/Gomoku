...
public:
    ...
    struct ThreatUpDetails
    {
    	...
    	static const uint32_t MAX_EMPTY_SPACES   = 10; // index [0-4] for normal; [5-9] symmetric. Duplication allowed! So must be filter while getting.
    ...
    ///////////////////////////////////////////////////////////////////////
    virtual bool FindThreatPattern( const Board::PositionXY& initialPosition, const Trend trend, const Board::Player playerPerspective ) final;
    ...
    ///////////////////////////////////////////////////////////////////////
    void SetBoard( const Board* pBoard )
    {
        m_pGomokuBoard = static_cast< const GomokuBoard* >( pBoard );
    }
    ...
    // Constructor.
    ThreatFinder( const uint32_t patternLenght, const uint32_t* pPointsView, const uint32_t pointsViewSize, const std::unordered_map< ThreatFinder::ThreatAtom, int, std::hash<int> > atomNumber )
     : m_pGomokuBoard( NULL )
...
protected:
    ...
    ///////////////////////////////////////////////////////////////////////
    virtual bool CheckThreat( const uint32_t pretendThreat,
    						  const uint32_t pointOfView,
    ...
    ///////////////////////////////////////////////////////////////////////
	virtual void GetThreatUpDetails( const Board::PositionXY initialPosition,
									 const Trend trend,
    ...
    ///////////////////////////////////////////////////////////////////////
    uint8_t StandarizePOV( const uint8_t hexCode,
    					   const uint8_t pointOfView,
    ...
    ///////////////////////////////////////////////////////////////////////
    void GetPieces( const uint8_t normHexCode,
    				const Board::PositionXY initialPositionNorm,
					const Board::Direction direction,
					Board::PositionXY pBuffer[],
    ...
    ///////////////////////////////////////////////////////////////////////
    bool MakeStepOnTrend( const bool isReversion,
    					  Board::PositionXY& currentXYPosition,
