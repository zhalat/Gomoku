/////////////////////////////////////////////////////////////////////////////////////////
/// @file Threat4CaseAA.hpp
///
/// Threat4CaseAA class declaration.
///
/// @par Full Description.
/// Threat4CaseAA finds pawns' which constitute one case of 'four thread' pattern.
...
#if !defined ( THREAT_FOUR_CASE_AA_HPP_ )
#define THREAT_FOUR_CASE_AA_HPP_
...
///////////////////////////////////////////////////////////////////////////////////////////
/// CLASS NAME: Threat4CaseAA.
///
/// Threat4CaseAA class declaration.
///
/// @par Full Description.
/// Allows to find case AA of threat four pattern on a gomoku board.
///
/// .xxx.x.
/// .x.xxx.
/// .xx.xx.
...
/// n/a
///////////////////////////////////////////////////////////////////////////////////////////
class Threat4CaseAA: public ThreatFinder
{
public:
	/// The size of 'Threat4CaseAA' threat pattern.
	static constexpr uint32_t PATTERN_LENGHT = 7;

	/// Tells how many pawns/gaps/asterixes this thrat has.
    static const std::unordered_map< ThreatFinder::ThreatAtom, int, std::hash<int> > ATOM_NUMBER_4AA;

    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat4CaseAA::CheckThreat
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat4CaseAA::GetThreatUpDetails
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat4CaseAA::PrepareSelfForNewSearch
    //
...
private:
    ...
    Threat4CaseAA( const Threat4CaseAA& );

    /// Private assignment operator - forbid copying.
    Threat4CaseAA& operator=( const Threat4CaseAA& );
...
#endif /* THREAT_FOUR_CASE_AA_HPP_ */
