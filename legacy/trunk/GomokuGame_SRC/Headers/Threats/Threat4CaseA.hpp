/////////////////////////////////////////////////////////////////////////////////////////
/// @file Threat4CaseA.hpp
///
/// Threat4CaseA class declaration.
///
/// @par Full Description.
/// Threat4CaseA finds pawns' which constitute one case of 'four thread' pattern.
...
#if !defined ( THREAT_FOUR_CASE_A_HPP_ )
#define THREAT_FOUR_CASE_A_HPP_
...
/// n/a
///////////////////////////////////////////////////////////////////////////////////////////
class Threat4CaseA: public ThreatFinder
{
public:
	/// The size of 'Threat4CaseA' threat pattern.
	static constexpr uint32_t PATTERN_LENGHT = 6;

	/// Tells how many pawns/gaps/asterixes this thrat has.
    static const std::unordered_map< ThreatFinder::ThreatAtom, int, std::hash<int> > ATOM_NUMBER_4A;

    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat4CaseA::CheckThreat
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat4CaseA::GetThreatUpDetails
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat4CaseA::PrepareSelfForNewSearch
    //
...
private:
    ...
    Threat4CaseA( const Threat4CaseA& );

    /// Private assignment operator - forbid copying.
    Threat4CaseA& operator=( const Threat4CaseA& );
