...
#if !defined ( THREAT_TWO_CASE_A_HPP_ )
#define THREAT_TWO_CASE_A_HPP_
...
// *.xx...
///////////////////////////////////////////////////////////////////////////////////////////
class Threat2CaseA: public ThreatFinder
{
public:
	/// The size of 'Threat2CaseA' threat pattern.
	static constexpr uint32_t PATTERN_LENGHT = 7;

	/// Tells how many pawns/gaps/asterixes this thrat has.
    static const std::unordered_map< ThreatFinder::ThreatAtom, int, std::hash<int> > ATOM_NUMBER_2A;

    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseA::CheckThreat
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseA::GetThreatUpDetails
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseA::PrepareSelfForNewSearch
    //
...
private:
    ...
    Threat2CaseA( const Threat2CaseA& );

    // Private assignment operator - forbid copying.
    Threat2CaseA& operator=( const Threat2CaseA& );
