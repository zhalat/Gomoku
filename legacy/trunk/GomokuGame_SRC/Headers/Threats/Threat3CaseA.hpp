...
#if !defined ( THREAT_THREE_CASE_A_HPP_ )
#define THREAT_THREE_CASE_A_HPP_
...
///-----------------------------------symmetric--------------------------------------------
///////////////////////////////////////////////////////////////////////////////////////////
class Threat3CaseA: public ThreatFinder
{
public:
	/// The size of 'Threat3CaseA' threat pattern.
	static constexpr uint32_t PATTERN_LENGHT = 7;

	/// Tells how many pawns/gaps/asterixes this thrat has.
    static const std::unordered_map< ThreatFinder::ThreatAtom, int, std::hash<int> > ATOM_NUMBER_3A;

    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat3CaseA::CheckThreat
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat3CaseA::GetThreatUpDetails
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat3CaseA::PrepareSelfForNewSearch
    //
...
private:
    ...
    Threat3CaseA( const Threat3CaseA& );

    /// Private assignment operator - forbid copying.
    Threat3CaseA& operator=( const Threat3CaseA& );
...
#endif /* THREAT_THREE_CASE_A_HPP_ */
