...
Threat3CaseAA::Threat3CaseAA()
 : ThreatFinder( PATTERN_LENGHT, m_PointsView, NUMELEM( m_PointsView ), ATOM_NUMBER_3AA )
{
	// nothing to do.
}

///	Check pretendThreat if meets all requirement to real threat.
bool Threat3CaseAA::CheckThreat( const uint32_t pretendThreat, const uint32_t pointOfView, const Board::Player playerPerspective ) const
{
...
void Threat3CaseAA::GetThreatUpDetails( const Board::PositionXY initialPosition, const Trend trend, ThreatUpDetails& rThreatUpDetails ) const
{
