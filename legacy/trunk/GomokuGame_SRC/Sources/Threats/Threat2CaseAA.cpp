...
Threat2CaseAA::Threat2CaseAA()
 : ThreatFinder( PATTERN_LENGHT, m_PointsView, NUMELEM( m_PointsView ), ATOM_NUMBER_2AA )
{
	// nothing to do.
}

///	Check pretendThreat if meets all requirement to real threat.
bool Threat2CaseAA::CheckThreat( const uint32_t pretendThreat, const uint32_t pointOfView, const Board::Player playerPerspective ) const
{
...
void Threat2CaseAA::GetThreatUpDetails( const Board::PositionXY initialPosition, const Trend trend, ThreatUpDetails& rThreatUpDetails ) const
{
