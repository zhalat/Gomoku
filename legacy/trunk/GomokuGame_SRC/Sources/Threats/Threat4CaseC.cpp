...
Threat4CaseC::Threat4CaseC()
 : ThreatFinder( PATTERN_LENGHT, m_PointsView, NUMELEM( m_PointsView ), ATOM_NUMBER_4C )
{
	// nothing to do.
}

///	Check pretendThreat if meets all requirement to real threat.
bool Threat4CaseC::CheckThreat( const uint32_t pretendThreat, const uint32_t pointOfView, const Board::Player playerPerspective ) const
{
...
void Threat4CaseC::GetThreatUpDetails( const Board::PositionXY initialPosition, const Trend trend, ThreatUpDetails& rThreatUpDetails ) const
{
