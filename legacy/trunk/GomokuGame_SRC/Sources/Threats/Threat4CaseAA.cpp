/////////////////////////////////////////////////////////////////////////////////////////
/// @file Threat4CaseAA.cpp
///
/// Threat4CaseAA class definition.
///
/// @par Full Description.
/// Threat4CaseAA finds pawns' which constitute one case of four pattern.
///
/// @if REVISION_HISTORY_INCLUDED
/// @par Edit History
/// - zhalat 16-Sep-2017 Initial revision.
...
// C++ PROJECT INCLUDES
#include "Threat4CaseAA.hpp"       // Threat4CaseAA definition.
...
const ThreatFinder::ThreatPattern Threat4CaseAA::m_ThreatPatternO[] =
{
	// Finds:
	// .ooo.o.
	// .o.ooo.
...
const uint32_t Threat4CaseAA::m_ThreatPatternElements = NUMELEM( m_ThreatPatternX );
...
Threat4CaseAA::Threat4CaseAA()
 : ThreatFinder( PATTERN_LENGHT, m_PointsView, NUMELEM( m_PointsView ), ATOM_NUMBER_4AA )
{
	// nothing to do.
}

///	Check pretendThreat if meets all requirement to real threat.
bool Threat4CaseAA::CheckThreat( const uint32_t pretendThreat, const uint32_t pointOfView, const Board::Player playerPerspective ) const
{
	...
	//3. Check empty space.
	const bool isEmptySpaceMatch = ( ( pretendThreat & emptyCntrMask ) & ( threatPattern & emptyCntrMask ) ) == ( threatPattern & emptyCntrMask );
...
void Threat4CaseAA::GetThreatUpDetails( const Board::PositionXY initialPosition, const Trend trend, ThreatUpDetails& rThreatUpDetails ) const
{
	...
	rThreatUpDetails.m_EndThreat = rThreatUpDetails.m_Gaps[ 2 ];
