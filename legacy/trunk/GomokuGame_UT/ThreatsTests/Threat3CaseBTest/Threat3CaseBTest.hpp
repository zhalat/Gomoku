/*
 * Threat3CaseBTest.hpp
 *
 *  Created on: Mar 12, 2016
 *      Author: Zbigniew Halat
 */

#ifndef TEST_THREAT_3_CASE_B_H_
#define TEST_THREAT_3_CASE_B_H_
...
class Threat3CaseBTest: public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE( Threat3CaseBTest );
	...
	CPPUNIT_TEST( SkipFalsePattern1 );
	...
	CPPUNIT_TEST( FindPatternAbuttedToBoardTest7 );
    ...
    private:
        ...
        void FindPatternAbuttedToBoardTest7();
