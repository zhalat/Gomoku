...
#ifndef TEST_THREAT_FOUR_CASE_AA_H_
#define TEST_THREAT_FOUR_CASE_AA_H_
...
class Threat4CaseAATest: public CppUnit::TestFixture
{
	CPPUNIT_TEST_SUITE( Threat4CaseAATest );
	...
	CPPUNIT_TEST( FindPatternAbbutedToFrameTest1 );
    ...
    public:
        ...
        void FindPatternAbbutedToFrameTest1();
...
#endif /* TEST_THREAT_FOUR_CASE_AA_H_ */
