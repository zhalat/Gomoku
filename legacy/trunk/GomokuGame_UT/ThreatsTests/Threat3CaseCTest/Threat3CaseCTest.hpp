/*
 * Threat3CaseCTest.hpp
 *
 *  Created on: Mar 12, 2016
 *      Author: Zbigniew Halat
 */

#ifndef TEST_THREAT_3_CASE_C_H_
#define TEST_THREAT_3_CASE_C_H_
...
class Threat3CaseCTest: public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE( Threat3CaseCTest );
	...
	CPPUNIT_TEST( FindPatternOnFallingTrendTest9 );
	CPPUNIT_TEST( FindPatternOnRisingTrendTest10 );
    ...
    private:
        ...
        void FindPatternOnFallingTrendTest9();
        void FindPatternOnRisingTrendTest10();
