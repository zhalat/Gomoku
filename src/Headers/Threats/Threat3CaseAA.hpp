...
#if !defined(THREAT_THREE_CASE_AA_HPP_)
#define THREAT_THREE_CASE_AA_HPP_
...
///-----------------------------------symmetric--------------------------------------------
///////////////////////////////////////////////////////////////////////////////////////////
class Threat3CaseAA : public ThreatFinder
{
   public:
    /// The size of 'Threat3CaseAA' threat pattern.
    static constexpr uint32_t PATTERN_LENGHT = 7;

    /// Tells how many pawns/gaps/asterixes this thrat has.
    static const std::unordered_map<ThreatFinder::ThreatAtom, int, std::hash<int>> ATOM_NUMBER_3AA;

    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat3CaseAA::CheckThreat
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat3CaseAA::GetThreatUpDetails
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat3CaseAA::PrepareSelfForNewSearch
    //
   ...
   private:
    ...
    Threat3CaseAA(const Threat3CaseAA &);

    /// Private assignment operator - forbid copying.
    Threat3CaseAA & operator=(const Threat3CaseAA &);
...
#endif /* THREAT_THREE_CASE_AA_HPP_ */
