...
#if !defined(THREAT_TWO_CASE_C_HPP_)
#define THREAT_TWO_CASE_C_HPP_
...
///-----------------------------------symmetric--------------------------------------------
///////////////////////////////////////////////////////////////////////////////////////////
class Threat2CaseC : public ThreatFinder
{
   public:
    /// The size of 'Threat2CaseC' threat pattern.
    static constexpr uint32_t PATTERN_LENGHT = 7;

    /// Tells how many pawns/gaps/asterixes this thrat has.
    static const std::unordered_map<ThreatFinder::ThreatAtom, int, std::hash<int>> ATOM_NUMBER_2C;

    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseC::CheckThreat
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseC::GetThreatUpDetails
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseC::PrepareSelfForNewSearch
    //
