...
#if !defined(THREAT_TWO_CASE_B_HPP_)
#define THREAT_TWO_CASE_B_HPP_
...
/// *...xxo
///////////////////////////////////////////////////////////////////////////////////////////
class Threat2CaseB : public ThreatFinder
{
   public:
    /// The size of 'Threat2CaseB' threat pattern.
    static constexpr uint32_t PATTERN_LENGHT = 7;

    /// Tells how many pawns/gaps/asterixes this thrat has.
    static const std::unordered_map<ThreatFinder::ThreatAtom, int, std::hash<int>> ATOM_NUMBER_2B;

    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseB::CheckThreat
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseB::GetThreatUpDetails
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseB::PrepareSelfForNewSearch
    //
   ...
   private:
    ...
    Threat2CaseB(const Threat2CaseB &);

    /// Private assignment operator - forbid copying.
    Threat2CaseB & operator=(const Threat2CaseB &);
