...
#if !defined(THREAT_THREE_CASE_C_HPP_)
#define THREAT_THREE_CASE_C_HPP_
...
///-----------------------------------symmetric--------------------------------------------
///////////////////////////////////////////////////////////////////////////////////////////
class Threat3CaseC : public ThreatFinder
{
   public:
    /// The size of 'Threat3CaseC' threat pattern.
    static constexpr uint32_t PATTERN_LENGHT = 7;

    /// Tells how many pawns/gaps/asterixes this thrat has.
    static const std::unordered_map<ThreatFinder::ThreatAtom, int, std::hash<int>> ATOM_NUMBER_3C;

    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat3CaseC::CheckThreat
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat3CaseC::GetThreatUpDetails
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat3CaseC::PrepareSelfForNewSearch
    //
   ...
   private:
    ...
    Threat3CaseC(const Threat3CaseC &);

    /// Private assignment operator - forbid copying.
    Threat3CaseC & operator=(const Threat3CaseC &);
...
#endif /* THREAT_THREE_CASE_C_HPP_ */
