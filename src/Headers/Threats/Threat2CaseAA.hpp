...
#if !defined(THREAT_TWO_CASE_AA_HPP_)
#define THREAT_TWO_CASE_AA_HPP_
...
/// n.a
///////////////////////////////////////////////////////////////////////////////////////////
class Threat2CaseAA : public ThreatFinder
{
   public:
    /// The size of 'Threat2CaseAA' threat pattern.
    static constexpr uint32_t PATTERN_LENGHT = 7;

    /// Tells how many pawns/gaps/asterixes this thrat has.
    static const std::unordered_map<ThreatFinder::ThreatAtom, int, std::hash<int>> ATOM_NUMBER_2AA;

    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseAA::CheckThreat
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseAA::GetThreatUpDetails
    //
    ...
    ///////////////////////////////////////////////////////////////////////
    // METHOD NAME: Threat2CaseAA::PrepareSelfForNewSearch
    //
   ...
   private:
    ...
    Threat2CaseAA(const Threat2CaseAA &);

    /// Private assignment operator - forbid copying.
    Threat2CaseAA & operator=(const Threat2CaseAA &);
