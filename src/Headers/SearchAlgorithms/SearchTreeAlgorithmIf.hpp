...
class SearchTreeAlgorithmIf
{
   public:
    ...
    ///////////////////////////////////////////////////////////////////////
    void SetDeep(const uint32_t deep) { m_DeepSearch = deep; }
    ...
    /// Get current deep.
    ///////////////////////////////////////////////////////////////////////
    uint32_t GetDeep() { return m_DeepSearch; }
    ...
    /// Set player who's  move is now.
    ///////////////////////////////////////////////////////////////////////
    void SetInitialPlayer(const Board::Player playerInit) { m_CurrentPlayerMove = playerInit; }
    ...
    ///////////////////////////////////////////////////////////////////////
    Board::Player WhoIsCurrentMove() const { return m_CurrentPlayerMove; }
