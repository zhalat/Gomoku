...
class BoardScore
{
   public:
    ...
    struct ThreatsOnBoard
    {
        ...
        ThreatsOnBoard() { memset(m_NumberRecognizedThreat, 0, sizeof(m_NumberRecognizedThreat)); }
    };
...
#warning \
    "GetGapsNonUnique/GetGapsUnique..GetCommonFieldNumber should be separated form this class as they're not related. Consider interface"
    /////////////////////////////////////////////////////////////////////////////
    ...
    /// @retval Player color.
    /////////////////////////////////////////////////////////////////////////////
    Board::Player GetPlayer() const { return m_player; }
    ...
    /////////////////////////////////////////////////////////////////////////////
    void SetPlayer(const Board::Player player) { m_player = player; }
    ...
    friend std::ostream & operator<<(std::ostream & _stream, const BoardScore & rBoardScore)
    {
        ...
        for(uint32_t i = 0; i < Score::MAX_KIND_OF_THREATS; ++i)
        {
            ...
            std::list<ThreatFinder::ThreatLocation>::const_iterator citer =
                rBoardScore.m_ThreatsOnBoard.m_RecognizedThreats[i].begin();
