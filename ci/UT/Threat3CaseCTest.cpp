...
TEST_F(Threat3CaseCTest, FindPatternOnHorizontalTrendTest3)
{
    ...
    ASSERT_TRUE(m_threatFinder->findThreatPattern(Board::PositionXY(1, 7), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
    ...
    ASSERT_FALSE(m_threatFinder->findThreatPattern(Board::PositionXY(1, 7), ThreatFinder::HORIZONTAL, Board::PLAYER_B));
}
...
TEST_F(Threat3CaseCTest, FindPatternOnFallingTrendTest9)
{
    ...
    ASSERT_FALSE(m_threatFinder->findThreatPattern(Board::PositionXY(12, 12), ThreatFinder::FALLING, Board::PLAYER_A));
    ASSERT_FALSE(m_threatFinder->findThreatPattern(Board::PositionXY(13, 13), ThreatFinder::FALLING, Board::PLAYER_A));
    ASSERT_FALSE(m_threatFinder->findThreatPattern(Board::PositionXY(14, 14), ThreatFinder::FALLING, Board::PLAYER_A));
}
...
TEST_F(Threat3CaseCTest, FindPatternOnRisingTrendTest10)
{
    ...
    m_board->putMove(Board::PositionXY(13, 1), Board::PLAYER_B);
    m_board->putMove(Board::PositionXY(14, 0), Board::PLAYER_B);
    ASSERT_FALSE(m_threatFinder->findThreatPattern(Board::PositionXY(11, 3), ThreatFinder::RISING, Board::PLAYER_B));
    ASSERT_FALSE(m_threatFinder->findThreatPattern(Board::PositionXY(13, 1), ThreatFinder::RISING, Board::PLAYER_B));
    ASSERT_FALSE(m_threatFinder->findThreatPattern(Board::PositionXY(14, 0), ThreatFinder::RISING, Board::PLAYER_B));
}
